...
| 구분 | 위치 | 용도 |
|---|---|---|
| **운영본 (Internal)** | `~/.claude/skills/백호-platoon-formation/skill.md` (PO PC) | PO 본인 작업 — 18종 사신 시리즈 스킬이 모두 설치된 환경 가정 |
...
다음은 **공개본에서만** 자기완결적으로 상세화되었다. 운영본은 PO 환경(18종 사신 시리즈 스킬 설치 완비)을 가정하므로 간결한 형태로 유지된다.

### 1. Phase 4 — 스킬 18종 핵심 역할 본문 기술
...
- [ ] 외부 방법론(예: 청룡 SAL Grid)·외부 스킬 참조 시 백호 본연 책임이 아니면 제거 — 백호 본문에 박지 않음
